...
**Процедура подписки по протоколу MQTT**
</div>
...
<div style="text-align:center" markdown="1">
![Инфраструктура типового решения IoT](https://github.com/bmstu-hackathon/example/blob/gh-pages/assets/intro03.png?raw=true)
